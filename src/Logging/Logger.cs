...
namespace Ocluse.LiquidSnow.Core.Logging
{
    /// <summary>
    /// Utilities for rapidly logging. These methods are only useful for debug logging.
    /// </summary>
    public static class Logger
    {
        ...
        {
            if (LogFilePath == null) throw new InvalidOperationException("No log destination file was specified");
